...
public class ParsedCandidatesTable implements Serializable {
    ...
    public ParsedCandidatesTable(ParsedCandidatesTable value) {
        this.id = value.id;
     ...
     */
    public ParsedCandidatesTable setId(UUID id) {
        this.id = id;
        return this;
    }
     ...
     */
    public ParsedCandidatesTable setUserId(UUID userId) {
        this.userId = userId;
        return this;
    }
     ...
     */
    public ParsedCandidatesTable setFido(String fido) {
        this.fido = fido;
        return this;
    }
     ...
     */
    public ParsedCandidatesTable setPictureUrl(String pictureUrl) {
        this.pictureUrl = pictureUrl;
        return this;
    }
     ...
     */
    public ParsedCandidatesTable setPositionName(String positionName) {
        this.positionName = positionName;
        return this;
    }
     ...
     */
    public ParsedCandidatesTable setSalary(Integer salary) {
        this.salary = salary;
        return this;
    }
     ...
     */
    public ParsedCandidatesTable setCvUrl(String cvUrl) {
        this.cvUrl = cvUrl;
        return this;
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (getClass() != obj.getClass())
            return false;
        final ParsedCandidatesTable other = (ParsedCandidatesTable) obj;
        if (this.id == null) {
            if (other.id != null)
                return false;
        }
    ...
    public String toString() {
        StringBuilder sb = new StringBuilder("ParsedCandidatesTable (");
